...
<head>
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="0; url=https://kubeworkz.io/signup-flow.html">
    ...
    <script>
        // Immediate redirect
        window.location.replace('https://kubeworkz.io/signup-flow.html');
    </script>
</head>
<body>
    <div class="container">
        ...
        <p style="margin-top: 2rem; font-size: 0.9rem;">
            ...
            <a href="https://kubeworkz.io/signup-flow.html">click here</a>
        </p>
    </div>
</body>
</html>
