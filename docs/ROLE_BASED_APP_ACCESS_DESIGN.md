...
**File**: `/home/ubuntu/Production/UC-1-Pro/services/ops-center/backend/config/apps_access.json`
...
# Backup files
cp src/pages/PublicLanding.jsx /home/ubuntu/backups/$(date +%Y%m%d)/
cp backend/server.py /home/ubuntu/backups/$(date +%Y%m%d)/
cp backend/config/*.json /home/ubuntu/backups/$(date +%Y%m%d)/
```
...
- [API_QUICK_REFERENCE.md](/home/ubuntu/Production/UC-1-Pro/services/ops-center/docs/ADMIN_API_QUICK_REFERENCE.md)
