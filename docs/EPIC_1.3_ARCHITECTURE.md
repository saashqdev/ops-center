...
Currently, Traefik configuration in UC-Cloud is managed manually through YAML files in `/home/ubuntu/Infrastructure/traefik/dynamic/`. This approach has several limitations:
...
```yaml
# /home/ubuntu/Infrastructure/traefik/dynamic/ops-center-routes.yml
...
class TraefikConfigWriter:
    ...
    def __init__(self, config_dir: str = "/home/ubuntu/Infrastructure/traefik/dynamic"):
...
class CertificateMonitor:
    ...
    def __init__(self, acme_file: str = "/home/ubuntu/Infrastructure/traefik/acme/acme.json"):
...
async def upload_certificate(
    ...
    cert_dir = Path("/home/ubuntu/Infrastructure/traefik/certs")
...
- `/home/ubuntu/Infrastructure/traefik/dynamic/domains.yml` - 15 routes
- `/home/ubuntu/Infrastructure/traefik/dynamic/middlewares.yml` - 8 middleware
- `/home/ubuntu/Infrastructure/traefik/dynamic/billing-routes.yml` - 5 routes
- `/home/ubuntu/Infrastructure/traefik/dynamic/api-domains.yml` - 8 routes
...
async def import_existing_config():
    ...
    config_dir = Path("/home/ubuntu/Infrastructure/traefik/dynamic")
    all_routes = []
    all_services = []
    all_middleware = []
...
cp /home/ubuntu/Infrastructure/traefik/dynamic/domains.yml \
   /home/ubuntu/Infrastructure/traefik/dynamic/domains.yml.backup.migration
...
```bash
# Archive old files
cd /home/ubuntu/Infrastructure/traefik/dynamic
