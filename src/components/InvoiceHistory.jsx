...
export default function InvoiceHistory() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className={`text-2xl font-bold ${theme.text.primary}`}>Invoice History</h2>
        <p className={`${theme.text.secondary} mt-1`}>View and download your past invoices</p>
      </div>
      ...
      {invoices.length === 0 ? (
        ...
        <div className={`${theme.card} border ${theme.border} rounded-lg overflow-hidden`}>
